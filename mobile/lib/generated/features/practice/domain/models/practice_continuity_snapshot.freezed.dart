...
class _$PracticeContinuityRecommendationImpl
  ...
  @override
  String toString() {
    return 'PracticeContinuityRecommendation(spaceId: $spaceId, activityId: $activityId, activityTitle: $activityTitle, reason: $reason, reasonLabel: $reasonLabel, generatedContentId: $generatedContentId, fallbackReason: $fallbackReason)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, spaceId, activityId,
      activityTitle, reason, reasonLabel, generatedContentId, fallbackReason);
