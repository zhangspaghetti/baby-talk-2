...
part of 'practice_activity_catalog.dart';
...
class _$PracticeCatalogActivitySummaryImpl
  ...
  @override
  String toString() {
    return 'PracticeCatalogActivitySummary(spaceId: $spaceId, spaceTitle: $spaceTitle, activityId: $activityId, title: $title, summary: $summary, sceneTag: $sceneTag, coachTip: $coachTip, totalPhraseCount: $totalPhraseCount, completedPhraseCount: $completedPhraseCount, completedPhraseIds: $completedPhraseIds, nextPhraseId: $nextPhraseId, nextPhraseEnglish: $nextPhraseEnglish, totalEvents: $totalEvents, skippedUnknownPhraseCount: $skippedUnknownPhraseCount, skippedMalformedEventCount: $skippedMalformedEventCount, lastEventTime: $lastEventTime, recentResult: $recentResult, warningMessage: $warningMessage)';
  }
