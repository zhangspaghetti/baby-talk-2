...
class _PlaybackPreferencesScreenState
              ...
              children: [
                ...
                SliderTheme(
                  ...
                  child: Slider(
                    ...
                    onChanged: (value) {
                      setState(() {
                        _audioSpeed = double.parse(value.toStringAsFixed(1));
                      });
                    },
                    onChangeEnd: (_) => _save(),
                  ),
                ...
                Row(
                  ...
                  children: [
                    Text('0.5x', style: TextStyle(fontSize: 12, color: colors.textMuted)),
                    Text('1.0x', style: TextStyle(fontSize: 12, color: colors.textMuted)),
                    Text('2.0x', style: TextStyle(fontSize: 12, color: colors.textMuted)),
                  ],
                ),
              ],
            ),
  ...
  void _save() {
    ref.read(settingsNotifierProvider.notifier).updatePlaybackPreferences(
