# Issue #39 frozen final candidate after #49
...
- Candidate ID: `m2-final-b89c8433c47d`.
- Mobile source: `b89c8433c47dc257d94ff362b02ce2a7ca23102e`.
- Installed APK SHA-256: `334084116a6d5abef4916bf2cb285c45763fd70fa4846eb00783969dad35188a`.
...
- Frozen manifest: `artifacts/m2-final-b89c8433c47d-20260808.json`.
- Manifest SHA-256: `0875041e8b068f51a558b7122105546cd2dc557963a2cdb1c685f790452da987`.

This tuple supersedes `m2-final-ad2c9ceeefff`; #49 changed the mobile source and APK. Backend source and deployed app-api artifact remain unchanged.
...
The formal M2-13 closure-candidate verifier ran for 978.4 seconds and returned exit code 0 with zero violations. Every manifest receipt remained `PASS`; no `FAIL`, `BLOCKED`, or `NOT RUN` status was reinterpreted.
...
Full CI ran from mobile source `b89c8433c47dc257d94ff362b02ce2a7ca23102e`, so the #49 custom-scene TalkBack traversal fix and its focused tests are part of the frozen machine-tested candidate.

## UAT boundary

The manifest is the only allowed input to final UAT. Candidate freeze does not substitute for #40. Actual TalkBack speech, audio audibility, gesture order, error/retry announcements, and focus return require explicit human observation on this exact tuple. Until those five same-tuple `HUMAN_ANDROID` records pass, #40 and #28 remain open.
