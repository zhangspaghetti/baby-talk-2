...
class GeneratedSpeechSynthesisConfigurationTest {
    ...
    @Test
    void dashScopeModeUsesTheExistingNamedSecretAndBuildsItsDedicatedAdapter() {
        contextRunner.withSystemProperties("BABY_TALK_AI_PROVIDER_DASHSCOPE_QWEN_API_KEY=test-only-key")
                .withPropertyValues(
                        "babytalk.practice.generated-audio.enabled=true",
                        "babytalk.practice.generated-audio.provider-mode=dashscope",
                        "babytalk.practice.generated-audio.base-url=https://dashscope.aliyuncs.com/api/v1/services/audio/tts/SpeechSynthesizer",
                        "babytalk.practice.generated-audio.api-key-environment-variable=BABY_TALK_AI_PROVIDER_DASHSCOPE_QWEN_API_KEY",
                        "babytalk.practice.generated-audio.model=qwen-audio-3.0-tts-flash",
                        "babytalk.practice.generated-audio.voice=loongeva_v3.6",
                        "babytalk.practice.generated-audio.allowed-download-hosts[0]=dashscope-result-bj.oss-cn-beijing.aliyuncs.com",
                        "babytalk.practice.generated-audio.provider-profile=qa-formal-v1"
                )
                .run(context -> assertThat(context.getBean(GeneratedSpeechSynthesisPort.class))
                        .isInstanceOf(DashScopeGeneratedSpeechProvider.class));
    }
    ...
    private String[] commonProperties() {
        return new String[] {
                ...
                "babytalk.practice.generated-audio.response-max-bytes=16384",
