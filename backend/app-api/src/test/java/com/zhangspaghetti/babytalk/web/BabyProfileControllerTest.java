...
class BabyProfileControllerTest extends AbstractIntegrationTest {
    ...
    void putCompletedCreatesProfileWithStarterFields() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/onboarding/profile")
                ...
                .andExpect(jsonPath("$.onboardingCompletedAt").value(dbTime(completedAt)));
    }
    ...
    private String dbTime(String instantText) {
        return Instant.parse(instantText).toString().replaceFirst("0+Z$", "Z");
    }
}
