...
public class PracticeGeneratedContentUtteranceEntity {
    ...
    public int approvedContentVersion() {
        return approvedContentVersion;
    }

    public void setApprovedContentVersion(int approvedContentVersion) {
        this.approvedContentVersion = approvedContentVersion;
    }
    ...
    public int providerAttemptNumber() {
        return providerAttemptNumber;
    }

    public void setProviderAttemptNumber(int providerAttemptNumber) {
