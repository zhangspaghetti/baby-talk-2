...
public class PracticeGeneratedContentEntity {
    ...
    public String getCoachTipZh() {
        return coachTipZh;
    }
    public void setCoachTipZh(String coachTipZh) {
        this.coachTipZh = coachTipZh;
    }
    ...
    public String getRetrievalTraceId() {
        return retrievalTraceId;
    }
    public void setRetrievalTraceId(String retrievalTraceId) {
        this.retrievalTraceId = retrievalTraceId;
    }
