...
public class PracticeGeneratedContentEntity {
    ...
    public String getOwnerKeyVersion() { return ownerKeyVersion; }
    ...
    public String getTprActionZh() { return tprActionZh; }
    ...
    public String getDeliveryGuidanceZh() { return deliveryGuidanceZh; }
    ...
    public String generationProfileVersion() { return generationProfileVersion; }
    public String getGenerationProfileVersion() { return generationProfileVersion; }
    public void setGenerationProfileVersion(String generationProfileVersion) { this.generationProfileVersion = generationProfileVersion; }
    public String generationProfileHash() { return generationProfileHash; }
    public String getGenerationProfileHash() { return generationProfileHash; }
    public void setGenerationProfileHash(String generationProfileHash) { this.generationProfileHash = generationProfileHash; }
    ...
    public String rubricContentHash() { return rubricContentHash; }
    public String getRubricContentHash() { return rubricContentHash; }
    public void setRubricContentHash(String rubricContentHash) { this.rubricContentHash = rubricContentHash; }
    public String evidencePolicyVersion() { return evidencePolicyVersion; }
    public String getEvidencePolicyVersion() { return evidencePolicyVersion; }
    public void setEvidencePolicyVersion(String evidencePolicyVersion) { this.evidencePolicyVersion = evidencePolicyVersion; }
    public String evidencePolicyContentHash() { return evidencePolicyContentHash; }
    public String getEvidencePolicyContentHash() { return evidencePolicyContentHash; }
    public void setEvidencePolicyContentHash(String evidencePolicyContentHash) { this.evidencePolicyContentHash = evidencePolicyContentHash; }
    public String providerRoutingPolicyVersion() { return providerRoutingPolicyVersion; }
    public String getProviderRoutingPolicyVersion() { return providerRoutingPolicyVersion; }
    public void setProviderRoutingPolicyVersion(String providerRoutingPolicyVersion) { this.providerRoutingPolicyVersion = providerRoutingPolicyVersion; }
    public String providerRoutingPolicyHash() { return providerRoutingPolicyHash; }
    public String getProviderRoutingPolicyHash() { return providerRoutingPolicyHash; }
    public void setProviderRoutingPolicyHash(String providerRoutingPolicyHash) { this.providerRoutingPolicyHash = providerRoutingPolicyHash; }
    public int generationAttemptLimit() { return generationAttemptLimit; }
    public int getGenerationAttemptLimit() { return generationAttemptLimit; }
    public void setGenerationAttemptLimit(int generationAttemptLimit) { this.generationAttemptLimit = generationAttemptLimit; }
    public int contentRefreshEpoch() { return contentRefreshEpoch; }
    public int getContentRefreshEpoch() { return contentRefreshEpoch; }
    public void setContentRefreshEpoch(int contentRefreshEpoch) { this.contentRefreshEpoch = contentRefreshEpoch; }
    ...
    public Boolean generationErrorRetryable() { return generationErrorRetryable; }
    public Boolean getGenerationErrorRetryable() { return generationErrorRetryable; }
    public void setGenerationErrorRetryable(Boolean generationErrorRetryable) { this.generationErrorRetryable = generationErrorRetryable; }
