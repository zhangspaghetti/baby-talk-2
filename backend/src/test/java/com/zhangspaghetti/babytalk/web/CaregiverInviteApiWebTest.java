...
@SpringBootTest(properties = {
        "spring.datasource.url=jdbc:h2:mem:caregiver-invite-api-web-test;MODE=PostgreSQL;DB_CLOSE_DELAY=-1;DATABASE_TO_UPPER=false",
...
class CaregiverInviteApiWebTest {
