...
- [x] 41-09-PLAN.md — TDD the sole RitualRoomSessionNotifier and whole-ProductSnapshot transient UI state.
...
**Wave 8** *(gap closure; blocked on 41-11)*

- [x] 41-12-PLAN.md — TDD single-flight reaction admission and exact unknown-outcome command reconciliation without exposing event identity to app or UI state.
