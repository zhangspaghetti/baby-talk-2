...
- [ ] 41-12-PLAN.md — TDD single-flight reaction admission and exact unknown-outcome command reconciliation without exposing event identity to app or UI state.
