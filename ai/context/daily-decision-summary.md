...
Status: red decisions confirmed; REFACTOR-003 generated-code strict migration canary complete; REFACTOR-006 Bearer JWT header task complete; REFACTOR-007 Mentor/AI fail-closed consent gate complete; REFACTOR-008 route contract pilot complete; REFACTOR-009 account repository contract seam complete; REFACTOR-010 practice repository characterization harness complete; REFACTOR-011 feature boundary report-only scan complete; REFACTOR-012 AsyncValue low-risk pilot complete; REFACTOR-013 local sensitive data lifecycle report-only scan complete; REFACTOR-014 token/i18n behavior-preserving cleanup pilot complete; REFACTOR-015 shared component extraction pilot complete; REFACTOR-016 accessibility semantics and localization pilot complete; REFACTOR-017 verification report suite complete; REFACTOR-017A integration blocker stabilization complete; REFACTOR-018 legacy deletion candidate audit complete; REFACTOR-019 installation ID delete primitive complete; REFACTOR-020 core-only clearance orchestrator complete; REFACTOR-021 AccountSession generated output migration complete; REFACTOR-022 practice interaction generated output migration complete; REFACTOR-023 share draft generated output migration complete; REFACTOR-024 local mentor suggestion generated output migration complete; REFACTOR-025 mentor fact event generated output migration complete; REFACTOR-026 practice phrase generated output migration complete; REFACTOR-027 interaction event payload generated output migration complete; REFACTOR-028 practice continuity generated output migration complete; REFACTOR-029 practice activity catalog generated output migration complete; REFACTOR-030 garden growth generated output migration complete; REFACTOR-031 onboarding generated output migration complete; REFACTOR-032 generated code hard gate complete; REFACTOR-033 critical UI coverage slice complete; REFACTOR-034 global coverage stabilization complete; production readiness and deletion remain blocked
...
HDR-R4-001 option 1 is confirmed and REFACTOR-020 implements the core-only local sensitive data clearance orchestrator without destructive flow wiring. REFACTOR-021 through REFACTOR-031 migrated `AccountSession.freezed.dart`, `InteractionEventEntity.g.dart`, `ShareLinkDraft.freezed.dart`, `LocalMentorSuggestion.freezed.dart`, `MentorFactEvent.freezed.dart`, `PracticePhrase.freezed.dart`, `InteractionEventPayload.freezed.dart`, `PracticeContinuitySnapshot.freezed.dart`, `PracticeActivityCatalog.freezed.dart`, `GardenGrowthSnapshot.freezed.dart`, and `OnboardingSnapshot.freezed.dart` into `mobile/lib/generated/`, reducing remaining co-located generated outputs to 0 Freezed files and 0 Isar/source_gen `.g.dart` files. REFACTOR-032 adds a Flutter test hard gate that rejects future generated Dart outputs under `mobile/lib/features/` and feature source `part` directives that point at co-located generated output. REFACTOR-033 adds focused critical UI widget tests and a report-only LCOV slice tool; the selected 8-file slice reaches 70.77%, above the 60% threshold. REFACTOR-034 stabilizes full coverage on Windows with `--concurrency=1` and raises global LCOV to 73.91% by covering household shared context/invite UI; 80% remains unresolved. Production readiness remains blocked by global coverage below the 80% target or missing approved exception, incomplete real-store lifecycle wiring, absent backup/encryption proof, absent performance benchmarks, target-platform/CI replay, and pending final human release confirmation. The next task should be explicitly selected: continue raising global coverage or approve an exception, design/approve real destructive lifecycle wiring with UX confirmation, create performance benchmarks, replay integration evidence on target CI/platforms, or plan a narrowly scoped approved follow-up migration. Yellow design/lint decisions should be resolved before broader cleanup or before converting report-only gates into hard CI failures.
