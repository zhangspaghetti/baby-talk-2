...
| Generated-code migration | REFACTOR-003 moved one Freezed output and one Isar output; REFACTOR-021 moved `AccountSession.freezed.dart`; REFACTOR-022 moved `InteractionEventEntity.g.dart` |
...
| Gap | Status |
|---|---|
| Full generated-code migration and hard gate | R003/R021/R022 migrated 2 Freezed outputs and 2 Isar/source_gen outputs; 9 Freezed outputs remain co-located; no hard gate is approved |
