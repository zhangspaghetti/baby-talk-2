...
| Generated-code migration | REFACTOR-003 moved one Freezed output and one Isar output under `mobile/lib/generated/`; REFACTOR-021 moved `AccountSession.freezed.dart` |
...
| Gap | Status |
|---|---|
| Full generated-code migration and hard gate | R003/R021 migrated 2 Freezed outputs and 1 Isar/source_gen output; 9 Freezed outputs and 1 Isar/source_gen output remain co-located; no hard gate is approved |
...
R017 completes the Phase 4 report suite, R017A restores local integration evidence, R003/R021 reduce generated-code placement risk, and R019/R020 reduce lifecycle-contract risk, but engineering production readiness is still blocked. The next engineering work should decide whether coverage, feature-boundary, real lifecycle wiring, remaining generated-code, performance, and target-platform replay gates are fixed or explicitly excepted.